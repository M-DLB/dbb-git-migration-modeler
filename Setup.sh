...
# Build Framework to use. Only zBuilder is supported
# Default to zBuilder
...
# Git Commit message
GIT_COMMIT_MESSAGE="Initial Load"
# Git Tag and Release Flag
GIT_TAG_RELEASE=true
# MOVE_FILES Flag when assessing usage of each file. If true, files will be moved
# to the owning repository if needed. Default is true
...
echo
# Specify DBB Build Framework configuration
echo "[SETUP] Specifying the Build Framework configuration"
echo "[INFO] Only zBuilder is supported as the build framework"
